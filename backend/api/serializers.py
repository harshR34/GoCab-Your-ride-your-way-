...
class DocumentSerializer(serializers.ModelSerializer):
    class Meta:
        model = Document
        fields = ['email','driving_license_num', 'adhaar_num', 'pan_number', 'license_plate','profilePhoto']
...
class DriverSerializer(serializers.ModelSerializer):
    class Meta:
        model = Driver
        fields = ['id','first_name','last_name','email','phone','documentStatus']
        
    
class DriverAvailabilitySerializer(serializers.ModelSerializer):
    class Meta:
        model = DriverAvailability
        fields = ['id','name','phone','lat','lon','availabilityStatus']
